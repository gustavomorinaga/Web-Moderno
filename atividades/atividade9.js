...
de 40 são reprovados. As notas possuem a seguinte regra de arredondamento: 
...
const classificaAluno = (nota) => {
    ...
    if (notaCorrigida >= 40) {
        return imprimir(`Aprovado com nota ${notaCorrigida}`)
    } else {
        return imprimir(`Reprovado com nota ${notaCorrigida}`)
    }
}
